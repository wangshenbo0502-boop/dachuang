...
// Initialize PostHog only if a token is configured (e.g. via .env)
...
// Preload ambient room audio buffers so PositionalAudio (useLoader) never
// triggers aborted in-flight requests when rooms mount/unmount.
useLoader.preload(AudioLoader, '/sounds/szummiasta.mp3');
useLoader.preload(AudioLoader, '/sounds/szummorza.mp3');
