...
const STORY_MILESTONES = [
    { id: 'intro', position: [0, 0, -15], type: 'intro', title: 'AI 就业助手', subtitle: '< 大学生求职导航 />' },
    { id: 'awards', position: [0, 0, -55], type: 'awards', title: '竞赛经历', subtitle: '记录你的竞赛与荣誉' },
    { id: 'journey', position: [0, 0, -95], type: 'journey', title: '学习旅程', subtitle: '学校 · 专业 · 项目实践' },
    { id: 'skills', position: [0, 0, -135], type: 'skills', title: '技能栈', subtitle: 'Java · Python · 前端 · AI 应用' },
];
